...
def generate_scenario_1_low_volatility():
    ...
    # Calibration: Matching Variances
    ...
    # Stationary Distributions (Long-term behavior at T=15)
    ...
    plt.savefig(output_dir / '06_probability_densities_fig6.png', dpi=300)
    plt.show()
