...
def simular_cir_intervencion():
    ...
    for i in range(1, steps):
        ...
        # Cumulative integral of beta_s = phi(s) * P_s
    ...
    ax2.set_ylim(0, 0.4) # Scale adjusted to see the braking effect
    ax2.grid(True, linestyle='--', alpha=0.5)
    
    plt.tight_layout()
    
    # Save using the automatic path in Modeling_CIR/figures
    plt.savefig(output_dir / '04_cir_modulated_fig4.png', dpi=300)
    plt.show()
